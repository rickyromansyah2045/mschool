                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>0858-9913-2060
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>mtsaladab@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Cikarang, Jawa Barat, Indonesia
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="200px;" src="<?php echo base_url().'theme/images/STMIK.jpg'?>"></a>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="foot-logo">
                    ...
                    <p><?php echo date('Y');?> © copyright by <a>Farhan Ramadhan</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Cikarang, Jawa Barat, Indonesia</p>
                        <p>Email : mtsaladab@gmail.com
                            <br> Phone : 0858-9913-2060</p>
